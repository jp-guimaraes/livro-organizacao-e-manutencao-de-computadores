# Capítulo 14 — Suporte e Gestão de Serviços
...
Um mesmo caso é útil para revisar a categorização apresentada na Seção 14.2: um sinal de Wi-Fi instável (mas não totalmente indisponível) não interrompe o uso, então não é um incidente; também não é um evento, porque não se trata de um sinal detectado por infraestrutura de monitoramento; é uma **solicitação**, e por não interromper o fluxo de ninguém, recebe prioridade baixa.
...
| *Speaker* de aviso desconectado ou invertido (falso negativo de "sem bipe") | Capítulo 11, §11.4.3 |
...
| Hipótese | Onde aprofundar |
|---|---|
| *Thermal throttling* por refrigeração insuficiente ou pasta térmica ressecada | Capítulo 4, §4.4; Capítulo 8, §8.6 |
